...
function Par(elem) { 
  let Par = elem[19].children[2].innerHTML; 
   par =  elem[1].children[2].innerHTML +  elem[2].children[2].innerHTML  + elem[3].children[2].innerHTML +
...
function Par(elem) { 
  let Par = elem[19].children[3].innerHTML; 
   par =  elem[1].children[3].innerHTML +  elem[2].children[3].innerHTML  + elem[3].children[3].innerHTML +
