...
let properties = {
  ...
  state : "StateName", 
  zipcode: 1234, 
  adress: 1234 & "noname rd",
  adress: function() { return 
 properties.adress + " " + properties.city + " " + properties.state + " " properties.zipcode }
}
document.getElementById("1B").innerHTML = properties.adress(); 
...
divB.appendChild(tableB);
tableB.setAttribute("style", "border:1px solid black;")
tableB.setAttribute("width", "100%")
...
appendTableRow4(table3B,"thingamabob","1.00","1",  " 1"); appenddTableRow4(table3B,"whachamcallit","2.00","2" , "4");
appendTableRow4(table3B,"Doohickey", "3.00", "3", "9");
appendTableRow(table3B), "total", " ", " "; " math " );
 math: function() =  { return 1 + 4 + 9}
